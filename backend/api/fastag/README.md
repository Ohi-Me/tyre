...
Shared backend modules for the `/fastag` domain.
...
Next.js route handlers in `frontend/web/app/api/v1/fastag/` import from here:

```ts
import { listLoads, createLoadSchema } from "@tyre/api/fastag";
```
