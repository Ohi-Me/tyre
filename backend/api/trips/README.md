...
Shared backend modules for the `/trips` domain.
...
Next.js route handlers in `frontend/web/app/api/v1/trips/` import from here:

```ts
import { listLoads, createLoadSchema } from "@tyre/api/trips";
```
