...
Shared backend modules for the `/trucks` domain.
...
Next.js route handlers in `frontend/web/app/api/v1/trucks/` import from here:

```ts
import { listLoads, createLoadSchema } from "@tyre/api/trucks";
```
