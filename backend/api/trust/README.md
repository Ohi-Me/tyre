...
Shared backend modules for the `/trust` domain.
...
Next.js route handlers in `frontend/web/app/api/v1/trust/` import from here:

```ts
import { listLoads, createLoadSchema } from "@tyre/api/trust";
```
