...
Shared backend modules for the `/voice` domain.
...
Next.js route handlers in `frontend/web/app/api/v1/voice/` import from here:

```ts
import { listLoads, createLoadSchema } from "@tyre/api/voice";
```
